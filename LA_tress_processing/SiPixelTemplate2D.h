...
struct SiPixelTemplateEntry2D { //!< Basic template entry corresponding to a single set of track angles
   ...
   float cce;               //!< charge collection efficiency
...
// load the private store with info from the
   ...
   float cce() {return cce_;}          //!< charge collection efficiency
...
private:
   ...
   float cce_;               //!< Charge Collection Efficiency [measured/generated cluster charge]
